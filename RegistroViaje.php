...
<body>
        ...
        <div class="viaje-container">
            ...
            <form id="viajeForm">
                ...
                <div class="form-actions">
                    <button type="button" class="btn-solicitar" onclick="solicitarViaje()">
                        Solicitar Viaje
                    </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Establecer fecha mínima como el mismo dia 
            ...
            // Configurar hora mínima si la fecha es el mismo dia
            ...
            if (fechaInput && horaInput) {
                fechaInput.addEventListener('change', function() {
                    ...
                    if (fechaSeleccionada === hoy) {
                        ...
                        const horaMin = ahora.getHours().toString().padStart(2, '0') + ':' + 
                                       ahora.getMinutes().toString().padStart(2, '0');
                        horaInput.min = horaMin;
                        
                        if (horaInput.value < horaMin) {
                            horaInput.value = horaMin;
                        }
                    } else {
                ...
                // Inicializar hora mínima si hoy
                const hoy = new Date().toISOString().split('T')[0];
        ...
        function solicitarViaje() {
            ...
            if (!hora) {
                alert('Por favor selecciona la hora de recogida');
                return;
            }
